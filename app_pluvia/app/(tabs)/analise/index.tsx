...
export default function Analises() {
  ...
  const logsFormatados = useMemo(() => {
    ...
    return logsReais.map((log: any) => {
      ...
      else if (["erro", "alerta", "falha"].includes(log.tipo_evento))
  ...
  const ConteudoDaTela = (
    <View className="gap-6 w-full pb-4">
          ...
          <View className="flex-row gap-2 items-center">
            <Select
              ...
              onValueChange={(option) => {
                if (option) setFiltroFazenda(option.value);
              }}
      ...
      <View className="flex-row flex-1 self-end gap-2">
        <Pressable 
              onPress={() => exportarParaCSV(pivosDropdownOptions, "Relatorio_Geral_Pivos", "compartilhar")}
              className="active:opacity-50 hover:opacity-80 cursor-pointer transition-opacity bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Download size={24} color="white" strokeWidth={2.5} />
            </Pressable>
            <Pressable 
              onPress={() => exportarParaCSV(pivosDropdownOptions, "Relatorio_Geral_Pivos", "email")}
              className="active:opacity-50 hover:opacity-80 cursor-pointer transition-opacity bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
      ...
      <View className="gap-y-5 mt-2">
        <View className="flex-row w-full justify-between items-center">
          ...
          <View className="flex-row gap-2 items-center">
            ...
            <Pressable 
              onPress={() => exportarParaCSV(alertasFormatados, "Historico_Alertas", "compartilhar")}
              className="active:opacity-50 hover:opacity-80 cursor-pointer transition-opacity bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Download size={24} color="white" strokeWidth={2.5} />
            </Pressable>
            <Pressable 
              onPress={() => exportarParaCSV(alertasFormatados, "Historico_Alertas", "email")}
              className="active:opacity-50 hover:opacity-80 cursor-pointer transition-opacity bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Send size={24} color="white" strokeWidth={2.5} />
            </Pressable>
        ...
        <Button
          ...
          onPress={() =>
            router.push({ pathname: "/(tabs)/analise/analiseAlertas" } as any)
          }
        >
      ...
      <View className="self-stretch gap-5 mt-4">
        <View className="flex-row w-full justify-between items-center">
          ...
          <View className="flex-row gap-2 items-center">
            <Select
              ...
              onValueChange={(option) => {
                if (option) setFiltroVisaoGeral(option.value);
              }}
              defaultValue={{ value: "todos", label: "Todos os Pivôs" }}
            >
              <SelectTrigger
        ...
        <View className="flex-row flex-1 self-end gap-2">
          <Pressable 
              onPress={() => exportarParaCSV(pivosDropdownOptions, "Visao_Geral", "compartilhar")}
              className="active:opacity-50 hover:opacity-80 cursor-pointer transition-opacity bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Download size={24} color="white" strokeWidth={2.5} />
            </Pressable>
            <Pressable 
              onPress={() => exportarParaCSV(pivosDropdownOptions, "Visao_Geral", "email")}
              className="active:opacity-50 hover:opacity-80 cursor-pointer transition-opacity bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Send size={24} color="white" strokeWidth={2.5} />
            </Pressable>
      ...
      <View className="self-stretch gap-5">
        <View className="flex-row w-full justify-between items-center">
          ...
          <View className="flex-row gap-2 items-center">
            <Select
              ...
              onValueChange={(option) => {
                if (option) setFiltroFalhas(option.value);
              }}
              defaultValue={{ value: "todos", label: "Todos os Pivôs" }}
            >
              <SelectTrigger
        ...
        <View className="flex-row flex-1 self-end gap-2">
            <Pressable 
              onPress={() => exportarParaCSV(falhasPeriodoMock, "Falhas_Periodo", "compartilhar")}
              className="active:opacity-50 hover:opacity-80 cursor-pointer transition-opacity bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Download size={24} color="white" strokeWidth={2.5} />
            </Pressable>
            <Pressable 
              onPress={() => exportarParaCSV(falhasPeriodoMock, "Falhas_Periodo", "email")}
              className="active:opacity-50 hover:opacity-80 cursor-pointer transition-opacity bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Send size={24} color="white" strokeWidth={2.5} />
            </Pressable>
          ...
          {(containerWidth > 0 || Platform.OS === "web") && (
            <Svg width={containerWidth || "100%"} height={chartHeight}>
              {falhasGridSteps.map((currentStep) => {
                const xPos =
                  leftAxisWidth + (currentStep / maxFalhasValue) * drawingWidth;
                return (
              ...
              {falhasPeriodoMock.map((item, index) => {
                ...
                const rowCenterY =
                  topPadding + index * falhasRowHeight + falhasRowHeight / 2;
      ...
      <View className="self-stretch gap-5">
        <View className="flex-row w-full justify-between items-center">
          ...
          <View className="flex-row gap-2 items-center">
            <Select
              ...
              onValueChange={(option) => {
                if (option) setFiltroTempo(option.value);
              }}
        ...
        <View className="flex-row flex-1 self-end gap-2">
          <Pressable 
              onPress={() => exportarParaCSV(tempoOperacaoMock, "Tempo_Operacao", "compartilhar")}
              className="active:opacity-50 bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Download size={24} color="white" strokeWidth={2.5} />
            </Pressable>
            <Pressable 
              onPress={() => exportarParaCSV(tempoOperacaoMock, "Tempo_Operacao", "email")}
              className="active:opacity-50 bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Send size={24} color="white" strokeWidth={2.5} />
            </Pressable>
            ...
            <Svg width={containerWidth || "100%"} height={chartHeight}>
              {tempoSteps.map((currentStep) => {
                const yPos =
                  topPadding +
                  chartInnerHeight -
                  (currentStep / tempoMax) * chartInnerHeight;
                return (
                  <G key={`grid-h-${currentStep}`}>
                    <Line
                      x1={leftAxisWidth}
                      y1={yPos}
                      x2={leftAxisWidth + drawingWidth}
                      y2={yPos}
                      stroke="#CACACA"
                      strokeWidth="1"
                    />
              ...
              <Line
                x1={leftAxisWidth}
                y1={topPadding + chartInnerHeight}
                x2={leftAxisWidth + drawingWidth}
                y2={topPadding + chartInnerHeight}
                stroke="#0D0D0D"
                strokeWidth="1"
              />
            </Svg>
      ...
      <View className="self-stretch gap-5">
        <View className="flex-row w-full justify-between items-center">
          ...
          <View className="flex-row gap-2 items-center">
            <Select
              ...
              onValueChange={(option) => {
                if (option) setFiltroAgua(option.value);
              }}
              defaultValue={{ value: "todos", label: "Todos os Pivôs" }}
            >
              <SelectTrigger
        ...
        <View className="flex-row flex-1 self-end gap-2">
          <Pressable 
              onPress={() => exportarParaCSV(consumoAguaMock, "Consumo_Agua", "compartilhar")}
              className="active:opacity-50 bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Download size={24} color="white" strokeWidth={2.5} />
            </Pressable>
            <Pressable 
              onPress={() => exportarParaCSV(consumoAguaMock, "Consumo_Agua", "email")}
              className="active:opacity-50 bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Send size={24} color="white" strokeWidth={2.5} />
            </Pressable>
            ...
            <Svg width={containerWidth || "100%"} height={chartHeight}>
              {aguaSteps.map((currentStep) => {
                const yPos =
                  topPadding +
                  chartInnerHeight -
                  (currentStep / aguaMax) * chartInnerHeight;
                return (
      ...
      <View className="self-stretch gap-5">
        <View className="flex-row w-full justify-between items-center">
          ...
          <View className="flex-row gap-2 items-center">
            <Select
              ...
              onValueChange={(option) => {
                if (option) setFiltroEnergia(option.value);
              }}
              defaultValue={{ value: "todos", label: "Todos os Pivôs" }}
            >
              <SelectTrigger
        ...
        <View className="flex-row flex-1 self-end gap-2">
          <Pressable 
              onPress={() => exportarParaCSV(consumoEnergiaMock, "Consumo_Energia", "compartilhar")}
              className="active:opacity-50 bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Download size={24} color="white" strokeWidth={2.5} />
            </Pressable>
            <Pressable 
              onPress={() => exportarParaCSV(consumoEnergiaMock, "Consumo_Energia", "email")}
              className="active:opacity-50 bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Send size={24} color="white" strokeWidth={2.5} />
            </Pressable>
            ...
            <Svg width={containerWidth || "100%"} height={chartHeight}>
              {energiaSteps.map((currentStep) => {
                const yPos =
                  topPadding +
                  chartInnerHeight -
                  (currentStep / energiaMax) * chartInnerHeight;
                return (
                ...
                d={`M ${consumoEnergiaMock
                  .map((item, i) => {
                    ...
                    const y =
                      topPadding +
                      chartInnerHeight -
                      (item.real / energiaMax) * chartInnerHeight;
                    return `${x} ${y}`;
                  })
                  .join(" L ")}`}
                fill="none"
                ...
                d={`M ${consumoEnergiaMock
                  .map((item, i) => {
                    ...
                    const y =
                      topPadding +
                      chartInnerHeight -
                      (item.estimado / energiaMax) * chartInnerHeight;
                    return `${x} ${y}`;
                  })
                  .join(" L ")}`}
                fill="none"
              ...
              {consumoEnergiaMock.map((item, index) => {
                ...
                const txtYReal =
                  isRealMaior || item.real === 0 ? yReal - 10 : yReal + 16;
                const txtYEstimado =
                  !isRealMaior || item.estimado === 0
                    ? yEstimado - 10
                    : yEstimado + 16;
      ...
      <View className="gap-y-5 mt-2 w-full">
        <View className="flex-row w-full justify-between items-center">
          <Text className="font-outfit-bold text-lg">Logs</Text>
          <View className="flex-row gap-2 items-center">
            <Select
              onOpenChange={setLogOpen}
              onValueChange={(option) => {
                if (option) setFiltroLog(option.value);
              }}
              defaultValue={{ value: "todos", label: "Todos os Pivôs" }}
            >
              <SelectTrigger
        ...
        <View className="flex-row flex-1 self-end gap-2">
          <Pressable 
              onPress={() => exportarParaCSV(logsFormatados, "Historico_Logs", "compartilhar")}
              className="active:opacity-50 hover:opacity-80 cursor-pointer transition-opacity bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Download size={24} color="white" strokeWidth={2.5} />
            </Pressable>
            <Pressable 
              onPress={() => exportarParaCSV(logsFormatados, "Historico_Logs", "email")}
              className="active:opacity-50 hover:opacity-80 cursor-pointer transition-opacity bg-primaria-azul rounded-[12px] w-[40px] h-[40px] items-center justify-center"
            >
              <Send size={24} color="white" strokeWidth={2.5} />
            </Pressable>
        ...
        <Button
          className="rounded-md w-full bg-secundaria-azul h-[40px] px-3 active:opacity-70"
          onPress={() =>
            router.push({ pathname: "/(tabs)/analise/analiseLogs" } as any)
          }
        >
          <Text className="text-white font-outfit-medium">
            Ver Tabela Completa
